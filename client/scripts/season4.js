...
const shutUpAndListen = {
  start_date: { year: 2014, month: 10, day: 24 },
  text: {
    headline: 'Are Space Suits Itchy?',
    text: shutUpAndListenText,
  },
  display_date: 'October 24, 2014*',
};
...
const constructiveCriticism = {
  ...
  text: {
    headline: 'Are Space Suits Itchy?',
    text: constructiveCriticismText,
  },
  display_date: 'October 24, 2014*',
};
...
const devilsPlaything = {
  start_date: { year: 2014, month: 10, day: 24 },
  text: {
    headline: 'Are Space Suits Itchy?',
    text: devilsPlaythingText,
  },
  display_date: 'October 24, 2014*',
};
