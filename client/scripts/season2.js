...
kumbayaText += '<ul><i>';
kumbayaText += '  <li>Minkowski and Eiffel lie to Mr. Cutter about the transmissions, request mission termination</li>';
kumbayaText += '  <li>Mr. Cutter does not terminate their mission</li>';
kumbayaText += '  <li>Minkowski and Eiffel find a message from Captain Lovelace hidden on the aux system</li>';
kumbayaText += '</i></ul>';
...
painfullyText += '<ul><i>';
painfullyText += '  <li>Minkowski and Eiffel are barely keeping the Hephaestus working</li>';
...
bachText += '<ul><i>';
bachText += '  <li>Eiffel goes 59 minutes and 29 seconds without making pop culture references</li>';
...
assistanceText += '  <li>Eiffel and Minkowski discover more about Captain Lovelace and the previous Hephaestus mission</li>';
...
killHilbertText += '  <li>Minkowski, Eiffel, and Hera weigh the pros and cons of killing Hilbert</li>';
killHilbertText += '  <li>Hera tries to kill Hilbert, accidentally almost kills Eiffel</li>';
...
paranoiaText += '  <li>Hilbert and Eiffel make repairs to Hera\'s systems – Nakedness ensues</li>';
...
commandingText += '  <li>Captain Lovelace makes contact with the Hephaestus</li>';
commandingText += '</i></ul>';
...
destructionText += '  <li>Minkowski discovers a bomb on Lovelace\'s shuttle</li>';
destructionText += '  <li>Lovelace commandeers the crew to repair her shuttle</li>';
...
noPressureText += '<ul><i>';
noPressureText += '  <li>Lovelace, Minkowski, and Eiffel work on the shuttle\'s life support</li>';
noPressureText += '  <li>Minkowski, Eiffel, and Hera hatch a plan to get rid of Lovelace\'s bomb</li>';
noPressureText += '</i></ul>';
...
brainDamageText += '  <li>Eiffel and Lovelace continue work on the shuttle</li>';
...
superheroText += '<ul><i>';
superheroText += '  <li>Hilbert and Eiffel work on manipulating Hera\'s sensors</li>';
...
knockKnockText += '<ul><i>';
knockKnockText += '  <li>Wolf 359 turns blue and increases in size, causing problems for the Hephaestus</li>';
knockKnockText += '  <li>Eiffel, Hilbert, and Minkowski experience some potentailly radiation-induced paranoia</li>';
...
whosThereText += '<ul><i>';
whosThereText += '  <li>Aliens communicate with the crew using clips from Eiffel\'s logs</li>';
whosThereText += '  <li>Lovelace is injured</li>';
whosThereText += '  <li>Eiffel uses Lovelace\'s shuttle to help the Hephaestus escape the star\'s gravity</li>';
whosThereText += '  <li>The bomb goes off, sending the shuttle and Eiffel into deep space</li>';
whosThereText += '</i></ul>';
